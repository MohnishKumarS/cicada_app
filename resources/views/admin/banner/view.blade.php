                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($banners as $banner)
                                            ...
                                            <tr id="banner-row-{{ $banner->id }}">
                                                ...
                                                <td><img src="{{ asset('admin-files/banners/' . $banner->image) }}"
                                                        alt="Banner Icon" width="50"></td>
                                                <td>{{ $banner->order }}</td>
                                                <td>
                                                    <button
                                                        class="btn banner-status {{ $banner->status == 1 ? 'btn-success' : 'btn-danger' }}"
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="javascript:void(0)" data-id="{{ $banner->id }}"
                                                            data-url="{{ route('deleteBanner', $banner->id) }}"
