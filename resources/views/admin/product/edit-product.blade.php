                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-2">
                          <img src="{{ asset('admin-files/products/' . $product->main_img) }}" width="65" />
                        </div>
                        @error('main_img')
                        <div class="mt-2 text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                      ...
                      <div class="d-flex">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="trending" value="1" id="trending1" {{ old('trending', $product->trending) == 1 ? 'checked' : '' }}>
                          <label class="form-check-label" for="trending1">
                            Yes
                          </label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="trending" value="2" id="trending2" {{ old('trending', $product->trending) == 2 ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-2">
                          ...
                          @foreach($additionalImages as $image)
                            <img src="{{ asset('admin-files/products/' . $image) }}" width="65" />
                          @endforeach
                        </div>
                      </div>
