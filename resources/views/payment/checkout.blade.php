                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="ccd-checkout__header">
                                    ...
                                    <p class="ccd-checkout__subtitle text-main">Please fill out the form below to complete
                                        your
                                        order.</p>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="ccd-form-group">
                                            ...
                                            <input type="text" class="form-control" id="pincode" name="pincode"
                                                ...
                                                onkeyup="return this.value = this.value.replace(/[^0-9]/g,'')" required>
                                            @error('pincode')
                                                <span class="text-danger">
                                                    {{ $message }}
                                                </span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="ccd-form-group">
                                            ...
                                            <input type="text" class="form-control" id="mobile" name="mobile"
                                                value="{{ old('mobile') }}"
                                                onkeyup="return this.value = this.value.replace(/[^0-9]/g,'')"
                                                ...
                                                <div class="accordion__content">
                                                    <div class="profile__block">
                                                        ...
                                                        <div class="py-3 text-center">
                                                            ...
                                                            <div class="mt-3">
                                                                <button type="submit" name="pay_method" value="online"
                                                                    class="btn-sec">Pay
                                                                    ₹{{ number_format($grandTotal, 2) }}</button>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="accordion__content">
                                                    <div class="profile__block">
                                                        <div class="py-3 text-center">
                                                            ...
                                                            <button type="submit" name="pay_method" value="cod"
                                                                class="btn-sec">Place Order</button>
                                                        </div>
                                                    </div>
                                                </div>
