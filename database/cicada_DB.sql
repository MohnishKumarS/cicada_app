...
-- Dumping structure for table cicada_1.banners
...
-- Dumping data for table cicada_1.banners: ~3 rows (approximately)
INSERT INTO `banners` (`id`, `image`, `order`, `status`, `view`, `created_at`, `updated_at`) VALUES
	(7, '1736657979.webp', '2', '1', 'mobile', '2025-01-11 23:29:39', '2025-01-11 23:29:39'),
	(8, '1736658267.webp', '1', '1', 'desktop', '2025-01-11 23:34:27', '2025-01-11 23:34:27'),
...
-- Dumping structure for table cicada_1.contacts
...
-- Dumping data for table cicada_1.contacts: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `additional_images` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table cicada_1.products: ~15 rows (approximately)
INSERT INTO `products` (`id`, `product_name`, `slug`, `product_description`, `size`, `quantity`, `gender`, `actual_price`, `offer_price`, `brand_id`, `category_id`, `color`, `main_img`, `additional_images`, `stock`, `trending`, `status`, `created_at`, `updated_at`) VALUES
	...
	(141, 'Nike Mens Downshifter Running Shoes', 'nike-mens-downshifter-running-shoes', NULL, 'xl', 2, NULL, 999, 399, 9, 13, NULL, 'nike_mens_downshifter_running_shoes_1736691450.jpg', NULL, 1, 2, 1, '2025-01-12 08:47:30', '2025-01-12 08:47:30');
...
INSERT INTO `users` (`id`, `name`, `email`, `mobile`, `email_verified_at`, `password`, `role`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(2, 'Yash', 'cicada@gmail.com', '9728934689', NULL, '$2y$12$cafoolE13b1.FCB3Nzm9/eKsG7YwG3S28Bc/P7J6yERo9aGMaIjPG', 'admin', NULL, '2024-12-18 04:58:52', '2025-01-10 09:01:21'),
	(3, 'MoniLee', 'yatibi5713@evusd.com', '6456456883', NULL, '$2y$12$T2CDyy9JX3GTW2m9iZ5UHO4VYxf/n.vpLD.QeBvkA336Mxdbe5BLS', 'user', NULL, '2024-12-18 05:35:24', '2025-01-11 23:51:51');
